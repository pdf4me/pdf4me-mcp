...
async def split_pdf_by_swiss_qr(
    ...
    if parsed is not None:
        raw_json_path = os.path.join(resolved_out, "split_pdf_by_swiss_qr_response.json")
        try:
    ...
    try:
        zip_path = write_file_from_bytes(final_resp.content, resolved_out, "split_pdf_by_swiss_qr.zip")
    except OSError as exc:
