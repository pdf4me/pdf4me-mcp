...
@tool(
    ...
    description=(
        ...
        "Provide pdf_file_path (local .pdf/.png/.jpg/.jpeg). docName resolution: uses basename unless doc_name is set. "
        "receipt_type examples: meal, supplies, hotel, fuel and energy, transportation, communication, "
        "subscriptions, entertainment, training, healthcare, generic. "
...
async def process_receipt(
    ...
    if not has_path:
        return ToolResult(
            content="Provide pdf_file_path (local receipt file)."
        )
